        ...
        <div class="col-auto pr-5" style={{ width: 530 }}>
          ...
          <div class="row" style={{marginTop: "80px"}}>
            <div class="col-auto" style={{marginRight: 35}}>
              ...
              <h6 class="mt-3">
                {numberFormat(props.data.travelers)}{" "}<span class="text-gray-500 font-weight-light">travelers</span>
              </h6>
            </div>
            <div class="col-auto" style={{marginRight: 35}}>
              <img width="36" height="36" src={IconTreasure} alt={`${props.data.treasures} Treasures`} />
              <h6 class="mt-3">
                {numberFormat(props.data.treasures)}{" "}<span class="text-gray-500 font-weight-light">treasures</span>
              </h6>
            </div>
            <div class="col-auto">
              <img width="36" height="36" src={IconCities} alt={`${props.data.travelers} Cities`} />
              <h6 class="mt-3">
                {numberFormat(props.data.cities)}{" "}<span class="text-gray-500 font-weight-light">cities</span>
              </h6>
            </div>
          </div>
        </div>
